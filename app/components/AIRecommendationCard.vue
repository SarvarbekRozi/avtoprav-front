 ...
 *
 * Robot — `avtoprav-robot-v3.webm` (VP9 + alfa kanal, 512x512). Animatsiya
    ...
    <div class="relative flex items-start gap-3 sm:gap-4">
      ...
      <div class="robot-slot shrink-0" aria-hidden="true">
        <video
          ...
          tabindex="-1"
          poster="/assets/avtoprav-robot-v3-poster.png"
        >
          <source src="/assets/avtoprav-robot-v3.webm" type="video/webm">
        </video>
      </div>
